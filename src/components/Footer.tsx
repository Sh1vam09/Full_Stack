export default function Footer() {
  return (
    <footer className="text-gray-600 body-font border-t border-t-[var(--border-color)]">
                    ...
                    >
                        <g>
                            <g>
                                ...
                                <path d="M96.006,56.112c-2.932,0-4.261,3.029-3.126,5.447c0.756,1.611,0.016,4.098-0.359,5.699 c-0.59,2.522,2.622,3.737,4.042,1.704c0.694-0.993,1.125-2.003,1.554-3.128c0.509-1.333,0.415-3.01,1.015-4.275 C100.278,59.143,98.928,56.112,96.006,56.112z"></path>
                                <path d="M100.456,38.079c-0.832-1.316-1.98-1.73-3.098-1.657c-1.117-0.073-2.266,0.341-3.098,1.657 c-1.065,1.683-0.757,4.691,0.354,6.478c0.011,0.1,0.022,0.199,0.033,0.299c0.391,3.487,5.03,3.487,5.422,0 c0.011-0.1,0.021-0.199,0.033-0.299C101.214,42.77,101.521,39.762,100.456,38.079z"></path>
                            </g>
                        </g>
                    </svg>
          <span className="ml-3 text-xl">Shivam Baheti</span>
        </a>
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© Shivam Baheti —
          <a href="https://twitter.com/Shivam" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">Shivam Baheti</a>
        </p>
